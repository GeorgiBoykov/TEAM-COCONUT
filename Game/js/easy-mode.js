...
//back-button
document.write('<div class="btn"><a href="game mode.html">Go Back</a></div>');
...
var arrow = function(){
    ...
    if (beersDrunk < 3){
        ctx.moveTo(35, 445);
    } else if (beersDrunk >= 3 && beersDrunk < 7) {
        ctx.moveTo(37, 435);
    } else if (beersDrunk >= 7 && beersDrunk < 10){
        ctx.moveTo(43, 427);
    } else if (beersDrunk >= 10 && beersDrunk < 14){
        ctx.moveTo(48, 420);
    } else if (beersDrunk >= 14 && beersDrunk < 17){
        ctx.moveTo(53, 417);
    } else if (beersDrunk >= 17 && beersDrunk < 20){
        ctx.moveTo(63, 414);
    } else if (beersDrunk >= 20 && beersDrunk < 24){
        ctx.moveTo(69, 411);
    } else if (beersDrunk >= 24 && beersDrunk < 27){
        ctx.moveTo(77, 414);
    } else if (beersDrunk >= 27 && beersDrunk < 30){
        ctx.moveTo(87, 417);
    } else if (beersDrunk >= 30 && beersDrunk < 34){
        ctx.moveTo(94, 421);
    } else if (beersDrunk >= 34 && beersDrunk < 40){
        ctx.moveTo(99, 427);
    } else if (beersDrunk >= 40 && beersDrunk < 42){
        ctx.moveTo(105, 435);
    } else {
        ctx.moveTo(107, 445);
    }
